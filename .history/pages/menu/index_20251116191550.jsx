...
const menuItems = {
  ...
  extras: [
    {
      ...
      img: "/images/extras/meat.jpg",
    },
    { id: 18, name: "Rice", price: "$2", desc: "Extra aromatic basmati rice", img: "/images/extras/rice.png" },
    { id: 19, name: "Pita", price: "$1 each", desc: 'Fresh 8" pita bread', img: "/images/extras/pita.png" },
  ...
  drinks: [
    { id: 24, name: "Soda 330ml can", price: "$1", desc: "Refreshing soda", img: "/images/drinks/soda-can.png" },
    { id: 25, name: "Water 500ml bottle", price: "$1", desc: "Pure bottled water", img: "/images/drinks/water-bottle.png" },
  ],
};
...
export default function Menu() {
  ...
  return (
    <section className="py-16 sm:py-20 lg:py-24 bg-white">
      <div className="container mx-auto px-4 sm:px-4 lg:px-8 max-w-7xl">
        {/* Menu Title */}
              ...
              <div className="p-4">
                {sidebarCategories.map((category) => (
                  <button
                    ...
                    className={`w-full flex items-center gap-4 p-3 mb-2 rounded-lg transition-all duration-300 relative ${active === category.key ? "bg-gray-50" : "hover:bg-gray-50"
                      }`}
                  >
                    ...
                    {/* Category Name */}
                    <span
                      className={`text-left font-semibold text-base ${active === category.key ? "text-[#ea1228]" : "text-gray-700"
                        }`}
                    >
                      {category.name}
                    </span>
