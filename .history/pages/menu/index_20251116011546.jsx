...
function getCategoryImage(category: keyof typeof categoryImages) {
...
const menuItems = {
  platters: [
    { id: 1, name: "Chicken Over Rice", price: 8.99, desc: "Juicy chicken served over aromatic rice.", img: "/images/platters/chicken-over-rice.png" },
    { id: 2, name: "Lamb Over Rice", price: 8.99, desc: "Ground lamb over aromatic rice.", img: "/images/platters/lamb-over-rice.png" },
  ],
  gyros: [
    { id: 3, name: "Chicken Gyro", price: 7.99, desc: "Juicy chicken in pita.", img: "/images/chicken-gyro.jpg" },
  ],
  salads: [
    { id: 4, name: "Chicken Salad", price: 8.99, desc: "Fresh salad with chicken.", img: "/images/chicken-salad.jpg" },
  ],
  philly: [
    { id: 5, name: "Philly Cheese Steak", price: 6.99, desc: "Classic Philly sandwich.", img: "/images/philly-cheese-steak.jpg" },
  ],
  extras: [
    { id: 6, name: "Meat", price: 3, desc: "Extra portion of meat.", img: "/images/meat.jpg" },
  ],
  drinks: [
    { id: 7, name: "Soda 330ml can", price: 1, desc: "Refreshing soda.", img: "/images/soda.jpg" },
  ],
};
...
export default function Menu() {
  ...
  const addToCart = (item: typeof menuItems["platters"][0]) => {
    setCart((prev) => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 lg:gap-10">
                ...
                {categories.map((category) => (
                  ...
                  >
                    ...
                    <div className="w-16 h-16 rounded-lg overflow-hidden flex-shrink-0 bg-gray-100">
                      <Image
                        src={getCategoryImage(category.key as keyof typeof categoryImages)}
                        alt={category.name}
                        width={64}
                        height={64}
          ...
          <div className="lg:col-span-3">
            <div className="bg-gray-50 rounded-xl p-6 sm:p-8 lg:p-10 shadow-lg">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6">
                      ...
                      <div className="flex-1 p-5 sm:p-6 flex flex-col justify-between">
                        ...
                        <div className="flex justify-between items-center mt-4 pt-4 border-t border-gray-200">
                          <span className="text-[#ea1228] font-bold text-2xl">${item.price.toFixed(2)}</span>
                          <button
                            onClick={() => addToCart(item)}
                            className="bg-[#ea1228] text-white px-6 py-2.5 rounded-lg text-sm font-semibold hover:bg-[#c11123] transition-all duration-300 shadow-md hover:shadow-lg"
                          >
                            Add to Order
                          </button>
                        </div>
              ...
              {/* Cart Summary */}
              {cart.length > 0 && (
                <div className="mt-8 pt-6 border-t border-gray-300 bg-white p-4 rounded-lg shadow-lg">
                  <h4 className="text-xl font-bold mb-4 text-[#0a1522]">Cart Summary</h4>
                  ...
                  <div className="flex justify-between font-bold text-[#ea1228] text-lg mt-4 border-t pt-2">
                    <span>Total:</span>
